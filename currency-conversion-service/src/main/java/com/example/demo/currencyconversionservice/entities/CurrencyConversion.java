package com.example.demo.currencyconversionservice.entities;
...
public class CurrencyConversion {
	...
	public CurrencyConversion(Long id, String from, String to, BigDecimal conversionMultiple, BigDecimal quantity,
			BigDecimal totalCalculatedAccount,String environment) {
		super();
		this.id = id;
		this.from = from;
		this.to = to;
	...
	public void setTotalCalculatedAccount(BigDecimal totalCalculatedAccount) {
		this.totalCalculatedAccount = totalCalculatedAccount;
	}
